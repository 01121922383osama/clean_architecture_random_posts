...
import 'features/Splah/data/datasources/lang_local_data_source.dart';
import 'features/Splah/data/repositories/lang_repository_impl.dart';
import 'features/Splah/domain/repositories/lang_repository.dart';
import 'features/Splah/domain/usecases/cahnge_local.dart';
import 'features/Splah/domain/usecases/get_save_data.dart';
import 'features/Splah/presentation/cubit/locale_cubit.dart';
import 'features/random_qoute/data/datasources/randome_qoute_local_data_sourece.dart';
import 'features/random_qoute/data/datasources/randome_qoute_remote_data_sourece.dart';
import 'features/random_qoute/data/repositories/qoute_repository_impl.dart';
import 'features/random_qoute/domain/repositories/qoute_reposatory.dart';
import 'features/random_qoute/domain/usecases/get_random_qoute.dart';
